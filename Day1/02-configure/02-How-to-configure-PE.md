...
## Configure settings in the PE console
- You can use the Puppet Enterprise (PE) console's graphical interface to configure settings for your PE.
- Changes you make in the console override Hiera data and data in pe.conf. It is best to use the console when you want to:
  - Set parameters that can be configured at runtime
...
- However, settings declared in the console override Hiera data
- It's best to use Hiera
